        ...
        <div className="h-[500px] md:h-[450px] p-6 rounded-md shadow-md relative transform duration-300 hover:-translate-y-3">
            ...
            <div className="mt-4 space-y-4">
                ...
                <div className="flex items-center justify-between absolute bottom-4 left-2 right-2">
                    <button className="font-semibold text-white py-2 px-4 rounded-md bg-primary"><Link>Details</Link></button>
                    <button className="font-semibold text-white py-2 px-4 rounded-md bg-secondary"><Link>Add To Cart</Link></button>
                </div>
            </div>
